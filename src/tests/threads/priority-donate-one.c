...
test_priority_donate_one (void) 
{
  ...
  lock_acquire (&lock);
//+++++> 
	//msg("before creating threads:: the lock:::: %d", list_size(&lock.semaphore.waiters));
...
//	msg("lock acquired");
 ...
 //+++++> 
	//msg("before releasing the lock:::: %d", list_size(&lock.semaphore.waiters));
	
  //---->
  lock_release (&lock);
 //+++++> 
	//msg("after releasing the lock:::: %d", list_size(&lock.semaphore.waiters));
