...
//================>>> Our implementation <<<==========================//
    ...
    struct list opened_files;           /* List of opened files/resources held by thread. */
    ...
    struct file* executable_file;       /* Thread's executable file. */
    bool is_child_loaded_successfully; 

    int exit_state;                      /* exit status of thread struct 
                                            was added in case thread has no 
                                            parent thread to inform such state. */
//===========================>>><<<===================================//
...
/* Struct child_thread holds information needed by Parent process when 
   its child terminates either normally or abnormally. */
struct child_thread {
